...
@Composable
fun EditScreen(navController: NavController, changeType: String, viewModel: EditViewModel= hiltViewModel()) {

    when (changeType) {
        Constant.EDIT_PROFILE -> EditProfile(navController,viewModel)
